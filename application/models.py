...
class Trek(db.Model):
    ...
    status = db.Column(db.Enum('pending', 'approved', 'open', 'closed', 'completed'), nullable=False, default='pending')
...
class Booking(db.Model):
    ...
    booking_status = db.Column(db.Enum('pending', 'booked', 'cancelled', 'completed'), nullable=False, default='pending')
